<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EliminaContratti.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="nascondi" runat="server">
        <a id="popup" class="ui-button ui-widget ui-corner-all" href="form/popupDelete/EliminaContrattiPopup.aspx">Elimina</a>
    </div>

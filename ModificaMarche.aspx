...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="nascondi" runat="server">
        <a id="popup" class="ui-button ui-widget ui-corner-all" href="form/popupModifica/ModificaMarchePopup.aspx">Modifica</a>
    </div>

    <!-- griglia -->
    <asp:GridView ID="griglia" runat="server" AutoGenerateSelectButton="True" DataKeyNames="codiceMarca" OnSelectedIndexChanged="griglia_SelectedIndexChanged"></asp:GridView>

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        ...
        <div id="nascondi" runat="server">
            <a id="popup" class="ui-button ui-widget ui-corner-all" href="form/popupModifica/ModificaSpesePopup.aspx">Inserisci</a>
        </div>

        <!-- griglia -->
        <asp:GridView ID="griglia" runat="server" AutoGenerateSelectButton="True" DataKeyNames="codiceTipoSpesa, codiceSpesa" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"></asp:GridView>

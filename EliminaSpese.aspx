...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="nascondi" runat="server">
        <a id="popup" class="ui-button ui-widget ui-corner-all" href="form/popupDelete/EliminaSpesePopup.aspx">Elimina</a>
    </div>


    <asp:GridView ID="griglia" runat="server" AutoGenerateSelectButton="True" DataKeyNames="codiceSpesa" OnSelectedIndexChanged="griglia_SelectedIndexChanged"></asp:GridView>
